/* Make adjustments to swap
-r flag: indicates sorting in reverse order
-f flag: fold upper and lower case together so that case distinctions are not made during sorting (a and A compare equal)
-d flag: directory order makes comparisons only on letters, numbers and blanks. 
Field-handling capability so sorting may be done on fields within lines.
*/
#include <stdio.h>
#include <ctype.h>
#include <stdlib.h>
